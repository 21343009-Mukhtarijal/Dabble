package com.adminsapplication.app.modules.jawabpertanyaantwo.`data`.model

import com.adminsapplication.app.R
import com.adminsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class JawabpertanyaantwoModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtWriteYourAnsw: String? =
      MyApp.getInstance().resources.getString(R.string.msg_write_your_answ)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtAnswerTwo: String? = MyApp.getInstance().resources.getString(R.string.lbl_answer)
  ,
  /**
   * TODO Replace with dynamic value
   */
